...
const cachingLibraryDescription = (
    <>
        The <TextAttentionCollector>aspnetcore</TextAttentionCollector> library that provides a set of caching
        ...
        <a
            ...
            target="_blank"
            rel="noreferrer">
            <TextAttentionCollector>NuGet{' '}<FaLink className='inline align-middle'/></TextAttentionCollector>
        </a>
        .
    </>
)
...
const functionalLibraryDescription = (
    <>
        The <TextAttentionCollector>dotnet</TextAttentionCollector> library that provides a set of functional
        types and extensions. Done with <TextAttentionCollector>csharp</TextAttentionCollector>. Currently hosted
        on{' '}
        <a
...
const richWebApiDescription = (
    <>
        ...
        scalable <TextAttentionCollector>aspnetcore</TextAttentionCollector> applications. It
...
const tailsDescription = (
    <>
        Project is a lightweight and highly flexible <TextAttentionCollector>typescript</TextAttentionCollector>
        <TextAttentionCollector>react</TextAttentionCollector> library that provides a structured wireframe for creating chainable
        dialog
        modals with support for popular component libraries, like <TextAttentionCollector>material-ui (mui)</TextAttentionCollector>.
        ...
        like <TextAttentionCollector>mui</TextAttentionCollector> and <TextAttentionCollector>ant design</TextAttentionCollector>.
    </>
)
